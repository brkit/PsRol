...
Describe 'New-RolRoleAssignmentScope' {
    ...
    It 'Should construct FUNCTION scope' {
        InModuleScope 'PsRol' {
            $functions = @(
                [PsRolFunction]@{ name = 'Consultant'; uuid = '00000000-0000-0000-0000-000000000002' },
                [PsRolFunction]@{ name = 'Leder'; uuid = '00000000-0000-0000-0000-000000000003' }
            )
            $scope = New-RolRoleAssignmentScope -Type FUNCTION -Functions $functions
